...
The name "TyDy", pronounced /ˈtaɪ daɪ/ is a blend of "Ty" and "Dy," where "Ty" represents "type", and "Dy" suggests "dynamic." It reflects the core focus of the library, which is to provide dynamic and type-safe utilities at runtime.
...
- 🛡️ **Default Value Assignment**: Automatically assign default values to object properties based on a schema.
...
%% Main Library
    ...
    %% Default Value Assignment Module
...
Now, assign default values based on a schema:
...
console.log(newObj); // Output: { name: 'John', age: 30, isActive: true }
```
...
console.log(transformedObj); // Output: { name: 'John', address: { zip: 12345 } }
```
